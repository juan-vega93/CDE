  ...
  useEffect(() => {
    ...
    const setup = async () => {
      try {
        ...
        console.log(
          "[bcfTopics proto]",
          Object.getOwnPropertyNames(Object.getPrototypeOf(modules.bcfTopics))
        );
        console.log(
          "[bcfTopics all props]",
          Reflect.ownKeys(modules.bcfTopics)
        );
        console.log("[bcfTopics config]", modules.bcfTopics.config);
        console.log(
          "[bcfTopics config methods]",
          Object.getOwnPropertyNames(Object.getPrototypeOf(modules.bcfTopics.config))
        );
